...
public class MultiplyReviewsRSSGenerator extends RSSGenerator {

    private String folder = "reviews";

    public MultiplyReviewsRSSGenerator(String blogTitle, String link) {
    ...
    public ArrayList<RSSTerm> getParsedItems(String rawString) {
        ...
        Element content = doc.select("div.itembox").first();
        
        Element post = doc.select("div.itemboxsub").first().parent();
